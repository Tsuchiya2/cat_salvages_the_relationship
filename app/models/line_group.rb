class LineGroup < ApplicationRecord
  ...
  validates :post_count,    presence: true, numericality: { only_integer: true, greater_than_or_equal_to: 0, less_than_or_equal_to: 100_000_000 }
  ...
  def change_status_to_wait
    ...
    update!(remind_at: Date.current.since(random_number.days), status: :wait, post_count: self.post_count + 1)
  end
end
